<template>
  <button style="background: none" @click="toggleColorMode">
    ...
    <svg v-else-if="colorMode.value === 'dark'" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#fff">
      <g stroke-width="0" />
      <g stroke-linecap="round" stroke-linejoin="round" />
      <g>
        <path
