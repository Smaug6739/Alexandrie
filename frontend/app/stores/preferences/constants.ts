...
export const DEFAULT_PREFERENCES = {
  ...
  style: 'default' as 'default' | 'glassmorphism' | 'minimal' | 'github' | 'modern' | 'fluent',
  ...
  documentTitlesNumbering: false as boolean,
  documentColoredTags: true as boolean,
