<template>
  <section class="faq">
    <div class="section-header">
      ...
      <p class="subtitle">{{ t('landing.faq.subtitle') }}</p>
    </div>
    ...
    <div class="faq-container">
      ...
      <div class="faq-cta">
        <div class="cta-content">
          ...
          <h3>{{ t('landing.faq.ctaTitle') }}</h3>
          <p>{{ t('landing.faq.ctaDescription') }}</p>
...
const faqs = computed(() => {
  void locale.value;
  return [
    { q: t('landing.faq.questions.0'), a: t('landing.faq.answer1') },
    { q: t('landing.faq.questions.1'), a: t('landing.faq.answer2') },
    { q: t('landing.faq.questions.2'), a: t('landing.faq.answer3') },
    { q: t('landing.faq.questions.3'), a: t('landing.faq.answer4') },
    { q: t('landing.faq.questions.4'), a: t('landing.faq.answer5') },
    { q: t('landing.faq.questions.5'), a: t('landing.faq.answer6') },
    { q: t('landing.faq.questions.6'), a: t('landing.faq.answer7') },
  ];
});
</script>
