export default {
  ...
  documents: {
    ...
    plantumlRendererDesc: 'Choose how PlantUML diagrams are rendered. Local rendering works offline but downloads the diagram engine on first use.',
    plantumlServer: 'PlantUML server',
    plantumlServerDesc: 'Diagram source is sent to this server to be rendered. Host your own PlantUML server to keep your content on your infrastructure.',
    section: 'Documents',
  ...
  security: {
    ...
    totp: {
      backupCodes: {
        copied: 'Codes copied!',
        copy: 'Copy all codes',
        description: 'If you lose your 2FA device, these codes are the only way to recover your account. Each code can only be used once.',
        download: 'Download backup codes',
        seen: 'I have saved these codes',
        title: 'Backup codes',
        warn: 'Keep these codes safe!',
      },
      description: 'Secure your account by requiring a 6-digit code during login.',
      disable: 'Disable 2FA',
      enable: 'Enable 2FA',
      enableStep1: '1. Scan this QR code with your Authenticator application (Google Authenticator, Bitwarden, etc.)',
      enableStep2: '2. Enter the 6-digit code generated by your Authenticator app below to verify and enable 2FA.',
      forced: '2FA is required for your account. Please enable it to continue using the app.',
      stateEnabled: '2FA is currently enabled on your account.',
