...
The following sections describe the main environment variables used by Alexandrie. For a complete list of all available variables, see [Environment variables reference](./6.configurations-list.md).
