...
const SubCategories_1 = __importDefault(require("../classes/SubCategories"));
const functions_1 = require("../utils/functions");
const Categories = new SubCategories_1.default();
function getAll(req, res) {
    Categories.getAll(req.params.main_category)
...
function add(req, res) {
    Categories.add(req.body.name, req.body.category, req.body.description, req.body.content, req.body.author)
...
function update(req, res) {
    ...
    Categories.put(req.params.resourceId, req.body.name, req.body.category, req.body.description, req.body.content, req.body.author)
        .then(() => res.status(201).json((0, functions_1.success)('success')))
        .catch(err => res.json((0, functions_1.error)(err.message)));
}
